...
var Swiper = function() {
    ...
    var B = {
        ...
        updateSlides: function() {
            ...
            if (p !== d && e
                ...
                const t =
                    `${s.containerModifierClass}backface-hidden`,
                    a = e.el
                    .classList
                    .contains(
                        t);
    ...
    function X(e) {
        ...
        if (l || (l = r > n ?
            ...
            if ("reset" === l)
                return void t.emit(
                    `slideResetTransition${i}`
                );
            t.emit(
                    `slideChangeTransition${i}`),
                "next" === l ? t
                .emit(
                    `slideNextTransition${i}`
                ) : t.emit(
    ...
    var R = {
        ...
        loopFix: function(e) {
            ...
            if (o
                ...
                requestAnimationFrame(
                    (() => {
                        o.__preventObserver__ = !
                            1
                    })),
                T && y
                .forEach((
                    e => {
                        d[e].swiperLoopMoveDOM = !
                            0,
                            u
                            .prepend(
                                d[
    ...
    function q(e) {
        ...
        i.allowTouchCallbacks && s
            .emit("touchMove", p), n
            .previousX = n.currentX,
            n.previousY = n
            .currentY, n.currentX =
            u, n.currentY = m;
        const h = n.currentX - n
            .startX,
            f = n.currentY - n
            .startY;
    ...
    function _(e) {
        ...
        if (s.isTouched = !1, s
            ...
            .currentTranslate, r
            .cssMode) return;
        if (r.freeMode && r.freeMode
            .enabled) return void t
            .freeMode
            .onTouchEnd({
                currentPos: h
            });
    ...
    function de(e, t) {
        ...
        if (e <= 0) return void s
            .prependSlide(t);
        if (e >= l) return void s
            .appendSlide(t);
        let o = n > e ? n + 1 : n;
        const d = [];
        for (let t = l - 1; t >=
        ...
        ue({
            ...
            setTranslate: () => {
                ...
                for (
                    ...
                    const
                        w =
                        `rotateX(${c(u?0:-r)}deg) rotateY(${c(u?r:0)}deg) translate3d(${h}px, ${g}px, ${v}px)`;
                    d <= 1 &&
                        d >
                        -
                        1 &&
                ...
                if (s
                    ...
                    if (
                        ...
                        .style
                        .transform =
                        `translate3d(0px, ${r/2+p.shadowOffset}px, ${-r/2}px) rotateX(89.99deg) rotateZ(0deg) scale(${p.shadowScale})`;
                    else {
                        const
                            e =
                            Math
                        ...
                        h.style
                            .transform =
                            `scale3d(${s}, 1, ${a}) translate3d(0px, ${n/2+i}px, ${-n/2/a}px) rotateX(-89.99deg)`
                    } const
                    g =
                    (d.isSafari ||
                        d
                ...
                s.style
                    .transform =
                    `translate3d(0px,0,${g}px) rotateX(${c(t.isHorizontal()?0:f)}deg) rotateY(${c(t.isHorizontal()?-f:0)}deg)`,
                    s
                    .style
                    .setProperty(
        ...
        ue({
            ...
            setTranslate: () => {
                ...
                for (
                    ...
                    const
                        h =
                        `translate3d(${u}px, ${m}px, 0px) rotateX(${r(p)}deg) rotateY(${r(c)}deg)`;
                    me(0,
                            l)
                        .style
                        .transform =
        ...
        s({
            ...
            setTranslate: () => {
                ...
                for (
                    ...
                    const
                        y =
                        `translate3d(${w}px,${v}px,${f}px)  rotateX(${p(h)}deg) rotateY(${p(m)}deg) scale(${b})`;
                    if (me(0,
                            t
                        )
                        .style
            ...
            setTranslate: () => {
                ...
                for (
                    ...
                    const
                        ...
                        w =
                        `rotateX(${o(h[0])}deg) rotateY(${o(h[1])}deg) rotateZ(${o(h[2])}deg)`,
                        b =
                        p <
                        0 ?
